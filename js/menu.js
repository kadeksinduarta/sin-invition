...
document.addEventListener("DOMContentLoaded", () => {
  const container = document.querySelector(".demo-undangan .paket");
          ...
          <a href="${theme.link}" target="_blank">
            ...
            <div class="deskripsi">
              <div class="contentt">
                <h2>${theme.name}</h2>
                <p>Harga</p>
                <h3 class="harga">Rp.${theme.price.toLocaleString()}</h3>
                <p class="harga-diskon">Rp. ${(theme.price * 0.5).toLocaleString()}</p>
              </div>
  ...
  renderThemes(menuDiHalamanUtama);
});
